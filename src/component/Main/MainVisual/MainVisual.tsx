    ...
    <section className="main-visual-wrap">
      <div className="main-visual-inner">
        <div className="main-visual_slogan">
          ...
          />
          <img
            className="tab-slogan"
            src={`${process.env.PUBLIC_URL}/assets/tab_newyear_logo.png`}
            alt="Peak Holiday VIBES"
          />
        </div>
        ...
        <div className="main-visual_set">
          <div className="set_common set_01">
            ...
            <img
              className="tab-drink"
              src={`${process.env.PUBLIC_URL}/assets/tab_drink1.png`}
              alt="푸른 용 클래식 밀크티 이미지"
            />
          </div>
          <div className="set_common set_02">
            ...
            <img
              className="tab-drink"
              src={`${process.env.PUBLIC_URL}/assets/tab_drink2.png`}
              alt="푸른 용 헤이즐넛 라떼 이미지"
            />
          </div>
          <div className="set_common set_03">
            ...
            <img
              className="tab-drink"
              src={`${process.env.PUBLIC_URL}/assets/tab_drink3.png`}
              alt="핑크 폼 딸기 라떼 이미지"
            />
          </div>
        </div>
